      ...
      <div className=''>
        ...
        <div className="flex w-full justify-between items-center ">
          ...
          <section className="relative h-[80vh] bg-white flex flex-col justify-center items-start pl-10 pt-20 flex-grow">
            ...
            <div className="grid grid-cols-2 w-full md:w-[30vw] gap-10">
              {data.map((item, index) => (
                <div key={index} className="bg-white flex flex-col justify-start items-start gap-y-5">
        ...
        <div className='relative w-full h-[30vw] bg-gray-300'>
          <div className='absolute inset-0 flex flex-col items-center mt-32 text-center'>
            <h1 className='font-bold text-5xl leading-snug max-w-8xl text-gray-800'>Our Experience & Measures</h1>
            <p className='text-xl mx-auto max-w-xl text-gray-400 font-medium'>If you want a drone for shooting 4K videos of your concerts, the next one is perfectly built just for you.</p>
          </div>
        ...
        <div className='relative w-full h-[40vw] bg-white'>
          ...
          <div className='absolute bottom-10 w-full flex justify-center'>
            <Link to="/PilotList" className='bg-blue-300 w-52 py-2 border rounded-full text-center'>Pilot List</Link>
          </div>
        </div>
        <Footer />
      </div>
