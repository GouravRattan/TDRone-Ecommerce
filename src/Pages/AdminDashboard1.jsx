...
const historydata = [
  {
    img: "/assets/tedrones-admin/china.svg",
    country: "China",
  ...
  {
    img: "/assets/tedrones-admin/tajmahal.svg",
    country: "India",
    place: "Taj Mahal",
    night: "4",
  ...
  {
    img: "/assets/tedrones-admin/niagrafall.svg",
    country: "Canada",
    place: "Niagara Falls",
    night: "12",
  ...
  {
    img: "/assets/tedrones-admin/italy.svg",
    country: "Italy",
  ...
  {
    img: "/assets/tedrones-admin/piramid.svg",
    country: "Greek",
    place: "Piramid",
    night: "4",
...
const tophotel = [
  {
    img: "/assets/tedrones-admin/billashotel.svg",
  ...
  {
    img: "/assets/tedrones-admin/tajhotel.svg",
    hotelname: "Taj Hotel",
    type: "Lux",
    beds: "2",
    adult: "2",
  ...
  {
    img: "/assets/tedrones-admin/greatwallhotel.svg",
  ...
  {
    img: "/assets/tedrones-admin/elitehotel.svg",
        ...
        <div className="px-5 md:px-10 py-5 bg-white flex items-center justify-between w-full fixed z-20">
          ...
          <div className="flex gap-12 md:mr-16">
            ...
            <div className="flex items-center gap-2.5 mr-28">
              ...
              <a href="#_">
                <img src="/assets/tedrones-admin/color.svg" alt="" />
              </a>
              <a href="#_">
                <img src="/assets/tedrones-admin/bell.svg" alt="" />
              </a>
              <a href="#_">
              ...
              <a href="#_">
                ...
                >
                  <Link
                    to="/"
                    className="text-md md:text-xl font-bold capitalize"
                  >
                            ...
                            >
                              ...
                              <td className="flex gap-1 whitespace-nowrap px-4">
                                <div className="flex items-center w-5">
                                  <img
                                    src="/assets/tedrones-admin/plane.svg"
                                    alt=""
                                  />
                                </div>
              ...
              {/* <div className="w-full xl:w-3/12 gap-5 flex flex-col md:flex-row xl:flex-col ">
                <div className="w-full xl:w-full md:h-auto xl:h-1/2 bg-[#FDFDFD] rounded-xl px-5 py-5 flex flex-col justify-between gap-10 ">
                  ...
                  <div className="text-center text-[#637381] font-normal">
                    Drone analytics calculated based on travels count
                  </div>
                </div>
                      ...
                      <div className="w-full flex flex-col gap-4">
                        ...
                        <div className="text-[#637381] flex justify-between items-center">
                          ...
                          <div className="text-sm flex items-center gap-1">
                            <div>
                              <img
                                src="/assets/tedrones-admin/star.svg"
                                alt=""
                              />
                            </div>
                            {data.rating}
