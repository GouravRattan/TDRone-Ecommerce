    ...
    <div className="w-full p-20 bg-white rounded-tl-3xl rounded-tr-3xl text-black">
      ...
      <div className="w-full flex gap-5 border-t-[1px] pt-10 mt-20 border-[#a1b562]">
        <div className="w-1/2">
          ...
          <button className="flex uppercase px-10 py-6 gap-10 items-center bg-zinc-900 mt-10 rounded-full text-white">
            Read More
          ...
          <div className="relative flex flex-col mt-6 text-gray-700 bg-white bg-clip-border rounded-xl w-96">
            <div className="p-6">
              ...
              <p className="block font-sans text-base antialiased font-light leading-relaxed text-inherit">
                ...
                ideas. Dynamically innovate resource-leveling customer support
                service.
              </p>
            </div>
          ...
          <div className="relative flex flex-col mt-6 text-gray-700 bg-white bg-clip-border rounded-xl w-96">
            <div className="p-6">
              ...
              <p className="block font-sans text-base antialiased font-light leading-relaxed text-inherit">
                ...
                value. Quickly maximize timely deliverables for real-time image.
              </p>
            </div>
            <div className="p-6 pt-0">
              <a href="#" className="inline-block">
